...
Rien trouvé côté XSS/injection dans le code lu (l'app utilise systématiquement une fonction `esc()` avant d'insérer du texte utilisateur dans le HTML) — pas d'audit exhaustif de chaque point d'insertion, hors budget de cette passe.
